...
class FA3_Yuri_muVnoPOI(PhysicsModel):
...
#        self.modelBuilder.doSet("POI","CMS_zz4l_fai1,muV")
        self.modelBuilder.doSet("POI","CMS_zz4l_fai1")

        self.modelBuilder.out.var("muf").setAttribute("flatParam")
        self.modelBuilder.out.var("muV").setAttribute("flatParam")
...
FA3_Yuri_muVnoPOI = FA3_Yuri_muVnoPOI()
