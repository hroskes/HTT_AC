...
class FA3_Yuri_muFisPOI_BSMyield0p1(PhysicsModel):
...
#        self.modelBuilder.out.var("muf").setAttribute("flatParam")
        ...
        self.modelBuilder.factory_('expr::bsmCoupling_VBF("@0*@1**2*{sigma3_VBF}/{sigma1_VBF}*0.1", muV,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_ZH("@0*@1**2*{sigma3_ZH}/{sigma1_ZH}*0.1", muV,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*@1**2*{sigma3_WH}/{sigma1_WH}*0.1", muV,a3)'.format(**xsecs))
...
FA3_Yuri_muFisPOI_BSMyield0p1 = FA3_Yuri_muFisPOI_BSMyield0p1()
