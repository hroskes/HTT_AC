...
class FA3_Yuri_muFisPOI_BSMyield0p01(PhysicsModel):
...
#        self.modelBuilder.out.var("muf").setAttribute("flatParam")
        ...
        self.modelBuilder.factory_('expr::bsmCoupling_VBF("@0*@1**2*{sigma3_VBF}/{sigma1_VBF}*0.01", muV,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_ZH("@0*@1**2*{sigma3_ZH}/{sigma1_ZH}*0.01", muV,a3)'.format(**xsecs))
        self.modelBuilder.factory_('expr::bsmCoupling_WH("@0*@1**2*{sigma3_WH}/{sigma1_WH}*0.01", muV,a3)'.format(**xsecs))
...
FA3_Yuri_muFisPOI_BSMyield0p01 = FA3_Yuri_muFisPOI_BSMyield0p01()
