...
namespace ch {
    ...
    void AddSMRun2Systematics_D0merged_fa2(CombineHarvester & cb, int control_region, bool mm_fit, bool ttbar_fit) {
      ...
      std::vector<std::string> sig_procs = {"ggH_htt","qqH_htt","WH_htt","ZH_htt","qqH_htt_0PH","WH_htt_0PH","ZH_htt_0PH","qqH_htt_0PHf05ph0","ZH_htt_0PHf05ph0","WH_htt_0PHf05ph0"};
...
//                                             "CMS_scale_j_$ERA", "shape", SystMap<>::init(1.00));
        ...
        cb.cp().process({"ggH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"ggH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"ggH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"WH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));
        ...
        cb.cp().process({"qqH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"WH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"ZH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"mt"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));
        ...
        cb.cp().process({"qqH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"qqH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"WH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"ZH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"et"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));
        ...
        cb.cp().process({"WH_htt125_0PH"}).channel({"em"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"WH_htt125_0PH"}).channel({"em"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"em"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "shape", SystMap<>::init(1.00));
        cb.cp().process({"ZH_htt125_0PH"}).channel({"em"}).bin_id({3}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));
	...
	*/
        ...
        //                );
            ...
            cb.cp().AddSyst(cb, "CMS_qqH_0PH_QCDUnc", "lnN", SystMap<channel, bin_id, process>::init
                        ...
                        ({"em"},{3},{"qqH_htt_0PH"}, 1.005)
                        ({"et"},{3},{"qqH_htt_0PH"}, 1.005)
                        ({"mt"},{3},{"qqH_htt_0PH"}, 1.002)
			({"tt"},{3,4,5,6,7},{"qqH_htt_0PH"}, 1.003)
                        );
        ...
        cb.cp().AddSyst(cb, "CMS_qqH_0PH_PDF", "lnN", SystMap<channel, bin_id, process>::init
                        ...
                        ({"em"},{3},{"qqH_htt_0PH"}, 1.005)
                        ({"et"},{3},{"qqH_htt_0PH"}, 1.005)
                        ({"mt"},{3},{"qqH_htt_0PH"}, 1.005)
                        ({"tt"},{3,4,5,6,7},{"qqH_htt_0PH"}, 1.005)
                        );        
        ...
        cb.cp().AddSyst(cb, "CMS_qqH_0PH_UEPS", "lnN", SystMap<channel, bin_id, process>::init
                        ...
                        ({"em"},{3},{"qqH_htt_0PH"}, 1.03)
                        ({"et"},{3},{"qqH_htt_0PH"}, 1.03)
                        ({"mt"},{3},{"qqH_htt_0PH"}, 1.03)
                        ({"tt"},{3,4,5,6,7},{"qqH_htt_0PH"}, 1.03)
                        );
...
//            // FIXME should have EWKZ in all
        ...
        if (control_region == 1) {
            ...
            cb.cp().bin({"mt_boosted","mt_wjets_boosted_cr","mt_vbf","mt_vbf_D0hplus_0to0p2","mt_vbf_D0hplus_0p2to0p4","mt_vbf_D0hplus_0p4to0p6","mt_vbf_D0hplus_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_wjets_boosted_cr","et_vbf","et_vbf_D0hplus_0to0p2","et_vbf_D0hplus_0p2to0p4","et_vbf_D0hplus_0p4to0p6","et_vbf_D0hplus_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"mt_boosted","mt_antiiso_boosted_cr","mt_vbf","mt_vbf_D0hplus_0to0p2","mt_vbf_D0hplus_0p2to0p4","mt_vbf_D0hplus_0p4to0p6","mt_vbf_D0hplus_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_antiiso_boosted_cr","et_vbf","et_vbf_D0hplus_0to0p2","et_vbf_D0hplus_0p2to0p4","et_vbf_D0hplus_0p4to0p6","et_vbf_D0hplus_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
	    ...
	    /*
            ...
            cb.cp().bin({"tt_vbf_D0hplus_0p4to0p6","tt_vbf_D0hplus_0p4to0p6_qcd_cr"}).process({"ZTT"}).AddSyst(cb, "rate_ZTT_cr_vbf_tt_D0hplus_0p4to0p6", "rateParam", SystMap<>::init(1.0));
        ...
        if (mm_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0hplus_0to0p2","tt_vbf_D0hplus_0p2to0p4","tt_vbf_D0hplus_0p4to0p8","tt_vbf_D0hplus_0p8to1"}).process({"ZTT"}).AddSyst(cb, "rate_mm_ZTT_vbf", "rateParam", SystMap<>::init(1.0));
        ...
        if (ttbar_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0hplus_0to0p2","tt_vbf_D0hplus_0p2to0p4","tt_vbf_D0hplus_0p4to0p8","tt_vbf_D0hplus_0p8to1"}).process({"TTJ","TTT","TTJ_rest"}).AddSyst(cb, "rate_ttbar", "rateParam", SystMap<>::init(1.0));
