...
namespace ch {
    ...
    void AddSMRun2Systematics_D0merged(CombineHarvester & cb, int control_region, bool mm_fit, bool ttbar_fit) {
...
//            // FIXME should have EWKZ in all
        ...
        if (control_region == 1) {
            ...
            cb.cp().bin({"mt_boosted","mt_wjets_boosted_cr","mt_vbf","mt_vbf_D0_0to0p2","mt_vbf_D0_0p2to0p4","mt_vbf_D0_0p4to0p6","mt_vbf_D0_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_wjets_boosted_cr","et_vbf","et_vbf_D0_0to0p2","et_vbf_D0_0p2to0p4","et_vbf_D0_0p4to0p6","et_vbf_D0_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"mt_boosted","mt_antiiso_boosted_cr","mt_vbf","mt_vbf_D0_0to0p2","mt_vbf_D0_0p2to0p4","mt_vbf_D0_0p4to0p6","mt_vbf_D0_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_antiiso_boosted_cr","et_vbf","et_vbf_D0_0to0p2","et_vbf_D0_0p2to0p4","et_vbf_D0_0p4to0p6","et_vbf_D0_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"tt_vbf_D0_0p4to0p8","tt_vbf_D0_0p4to0p8_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0p4to0p8", "rateParam", SystMap<>::init(1.0));
        ...
        if (mm_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0_0to0p2","tt_vbf_D0_0p2to0p4","tt_vbf_D0_0p4to0p8","tt_vbf_D0_0p8to1"}).process({"ZTT"}).AddSyst(cb, "rate_mm_ZTT_vbf", "rateParam", SystMap<>::init(1.0));
        ...
        if (ttbar_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0_0to0p2","tt_vbf_D0_0p2to0p4","tt_vbf_D0_0p4to0p8","tt_vbf_D0_0p8to1"}).process({"TTJ","TTT","TTJ_rest"}).AddSyst(cb, "rate_ttbar", "rateParam", SystMap<>::init(1.0));
