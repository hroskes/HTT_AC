...
namespace ch {
    ...
    void AddSMRun2Systematics(CombineHarvester & cb, int control_region, bool mm_fit, bool ttbar_fit) {
      ...
      std::vector<std::string> sig_procs = {"ggH_htt","qqH_htt","WH_htt","ZH_htt","qqH_htt_0M","WH_htt_0M","ZH_htt_0M"};
...
//                                             "CMS_scale_j_$ERA", "shape", SystMap<>::init(1.00));
	    ...
	    // YM
            cb.cp().process(JoinStr({sig_procs, all_mc_bkgs})).channel({"tt"}).bin_id({10,11,12,13,14,15,16}).AddSyst(cb,
                                                                                                 "CMS_scale_j_"+uncert+"_$ERA", "shape", SystMap<>::init(1.00));
        }
        ...
        //JES for tt, YM
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_AbsoluteMPFBias_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_AbsoluteScale_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_AbsoluteStat_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.01244515401));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_Fragmentation_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC1_$ERA", "lnN", SystMap<>::init(1.0065364049));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC2_$ERA", "lnN", SystMap<>::init(1.00532999771));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtHF_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtRef_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984040861582));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeFSR_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeJERHF_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC1_$ERA", "lnN", SystMap<>::init(1.0065364049));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.01175413407));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01148273772));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeStatFSR_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeStatHF_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_SinglePionECAL_$ERA", "lnN", SystMap<>::init(0.994091250891));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_SinglePionHCAL_$ERA", "lnN", SystMap<>::init(0.994091250891));
        cb.cp().process({"WH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_TimePtEta_$ERA", "lnN", SystMap<>::init(1.00590874911));
        cb.cp().process({"ZH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00911644818));
        cb.cp().process({"ZH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.983412519208));
        cb.cp().process({"ZH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.00923747942));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.01961480886));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpDataMC_$ERA", "lnN", SystMap<>::init(1.01299795333));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC2_$ERA", "lnN", SystMap<>::init(1.00665434016));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtHF_$ERA", "lnN", SystMap<>::init(1.00490130831));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtRef_$ERA", "lnN", SystMap<>::init(1.00546859182));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.968785018213));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeFSR_$ERA", "lnN", SystMap<>::init(0.995177865431));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00901271758));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01778152211));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeStatHF_$ERA", "lnN", SystMap<>::init(1.00507694785));
        cb.cp().process({"ZTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_TimePtEta_$ERA", "lnN", SystMap<>::init(0.995758100964));
        cb.cp().process({"TTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.01324266977));
        cb.cp().process({"TTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC1_$ERA", "lnN", SystMap<>::init(1.01324266977));
        cb.cp().process({"TTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(1.01324266977));
        cb.cp().process({"TTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC1_$ERA", "lnN", SystMap<>::init(1.01324266977));
        cb.cp().process({"TTT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.01145848957));
        cb.cp().process({"TTJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.01601456021));
        cb.cp().process({"TTJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC1_$ERA", "lnN", SystMap<>::init(1.01601456021));
        cb.cp().process({"ggH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"ggH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"ggH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"qqH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"qqH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"qqH_htt125"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"ggH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"ggH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"ggH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"qqH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"qqH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"qqH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"WH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.978152281977));
        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00304039446));
        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.01605523932));
        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.00733361765));
        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.984061069106));
        cb.cp().process({"ZH_htt125_0M"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "shape", SystMap<>::init(1.00));

        cb.cp().process({"W"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.957481826367));
        cb.cp().process({"VVJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.01563010796));
        cb.cp().process({"VVJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC1_$ERA", "lnN", SystMap<>::init(1.01563010796));
        cb.cp().process({"VVJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(1.01304150742));
        cb.cp().process({"VVJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.00550070401));
        cb.cp().process({"VVJ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.00258860054));
        cb.cp().process({"VVT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_FlavorQCD_$ERA", "lnN", SystMap<>::init(1.0054169136));
        cb.cp().process({"VVT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativeBal_$ERA", "lnN", SystMap<>::init(0.970464556154));
        cb.cp().process({"VVT"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtHF_$ERA", "lnN", SystMap<>::init(1.0127700062));
        cb.cp().process({"ZL"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_PileUpPtEC2_$ERA", "lnN", SystMap<>::init(1.04978898077));
        cb.cp().process({"ZL"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,"CMS_scale_j_RelativePtEC2_$ERA", "lnN", SystMap<>::init(1.04978898077));
...
//                                           "CMS_htt_QCD_$CHANNEL_13TeV", "lnN", SystMap<>::init(1.20));
        ...
        cb.cp().process({"QCD"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,
...
//        
	...
	*/
        ...
        //scale_gg on signal
	/* FIXME senka, for etau, mutau: ggH_htt125_CMS_scale_gg_13TeVUp->ggH125_CMS_scale_gg_13TeVUp

        cb.cp().process( {"ggH_htt"}).channel({"et","mt","tt","em"}).AddSyst(cb,
								   "CMS_scale_gg_$ERA", "shape", SystMap<>::init(1.00));
	*/
        cb.cp().process( {"ggH_htt"}).channel({"tt"}).AddSyst(cb,
								   "CMS_scale_gg_$ERA", "shape", SystMap<>::init(1.00));
	...
	*/
        ...
        else
        {
            ...
            cb.cp().process( {"ZL","ZTT","ZJ", "ZJ_rest", "EWKZ"}).channel({"tt"}).bin_id({3,4,5,6,7}).AddSyst(cb,
...
//            // FIXME should have EWKZ in all
	    ...
	    //                              "CMS_htt_zmumuShape_VBF_$ERA", "shape", SystMap<>::init(1.00));
            ...
            if(control_region > 0)
            {
                ...
                cb.cp().process( {"ZL","ZTT","ZJ", "ZJ_rest", "EWKZ"}).channel({"et","mt"}).bin_id({12,15}).AddSyst(cb,
                                                 "CMS_htt_zmm_norm_extrap_VBF_lt_$ERA", "lnN", SystMap<>::init(1.15));
                cb.cp().process( {"ZL","ZTT","ZJ", "ZJ_rest", "EWKZ"}).channel({"tt"}).bin_id({12,13,14,15,16}).AddSyst(cb,
                                                 "CMS_htt_zmm_norm_extrap_VBF_tt_$ERA", "lnN", SystMap<>::init(1.10));
        ...
        if (control_region == 1) {
            ...
            cb.cp().bin({"mt_boosted","mt_wjets_boosted_cr","mt_vbf","mt_vbf_D0_0to0p2","mt_vbf_D0_0p2to0p4","mt_vbf_D0_0p4to0p6", "mt_vbf_D0_0p6to0p8","mt_vbf_D0_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_wjets_boosted_cr","et_vbf","et_vbf_D0_0to0p2","et_vbf_D0_0p2to0p4","et_vbf_D0_0p4to0p6", "et_vbf_D0_0p6to0p8","et_vbf_D0_0p8to1"}).process({"W"}).AddSyst(cb, "rate_W_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_wjets_vbf_cr"}).process({"W"}).AddSyst(cb, "rate_W_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"mt_boosted","mt_antiiso_boosted_cr","mt_vbf","mt_vbf_D0_0to0p2","mt_vbf_D0_0p2to0p4","mt_vbf_D0_0p4to0p6", "mt_vbf_D0_0p6to0p8","mt_vbf_D0_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_mt", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"mt_vbf","mt_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_mt", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"et_boosted","et_antiiso_boosted_cr","et_vbf","et_vbf_D0_0to0p2","et_vbf_D0_0p2to0p4","et_vbf_D0_0p4to0p6", "et_vbf_D0_0p6to0p8","et_vbf_D0_0p8to1"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_boosted_et", "rateParam", SystMap<>::init(1.0));
//            cb.cp().bin({"et_vbf","et_antiiso_vbf_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_et", "rateParam", SystMap<>::init(1.0));
            ...
            cb.cp().bin({"tt_vbf_D0_0to0p2","tt_vbf_D0_0to0p2_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0to0p2", "rateParam", SystMap<>::init(1.0));
            cb.cp().bin({"tt_vbf_D0_0p2to0p4","tt_vbf_D0_0p2to0p4_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0p2to0p4", "rateParam", SystMap<>::init(1.0));
            cb.cp().bin({"tt_vbf_D0_0p4to0p6","tt_vbf_D0_0p4to0p6_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0p4to0p6", "rateParam", SystMap<>::init(1.0));
            cb.cp().bin({"tt_vbf_D0_0p6to0p8","tt_vbf_D0_0p6to0p8_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0p6to0p8", "rateParam", SystMap<>::init(1.0));
            cb.cp().bin({"tt_vbf_D0_0p8to1","tt_vbf_D0_0p8to1_qcd_cr"}).process({"QCD"}).AddSyst(cb, "rate_QCD_cr_vbf_tt_D0_0p8to1", "rateParam", SystMap<>::init(1.0));
	    ...
	    /*
            ...
            cb.cp().bin({"tt_vbf_D0_0p4to0p6","tt_vbf_D0_0p4to0p6_qcd_cr"}).process({"ZTT"}).AddSyst(cb, "rate_ZTT_cr_vbf_tt_D0_0p4to0p6", "rateParam", SystMap<>::init(1.0));
        ...
        if (mm_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0_0to0p2","tt_vbf_D0_0p2to0p4","tt_vbf_D0_0p4to0p6", "tt_vbf_D0_0p6to0p8","tt_vbf_D0_0p8to1"}).process({"ZTT"}).AddSyst(cb, "rate_mm_ZTT_vbf", "rateParam", SystMap<>::init(1.0));
        ...
        if (ttbar_fit) {
            ...
            cb.cp().bin({"tt_vbf","tt_vbf_D0_0to0p2","tt_vbf_D0_0p2to0p4","tt_vbf_D0_0p4to0p6", "tt_vbf_D0_0p6to0p8","tt_vbf_D0_0p8to1"}).process({"TTJ","TTT","TTJ_rest"}).AddSyst(cb, "rate_ttbar", "rateParam", SystMap<>::init(1.0));
